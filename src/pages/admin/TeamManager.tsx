...
export default function TeamManager() {
  ...
  return (
    <div className="space-y-8">
      <header>
        <h1 className="text-4xl font-display font-black text-indigo-brand uppercase mb-2">
          Gestión de Socios
        </h1>
        <p className="text-gray-400 font-medium">Administra quiénes tienen acceso a este panel de control.</p>
      </header>
      ...
      <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm max-w-2xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-indigo-brand uppercase tracking-wider">Añadir Nuevo Socio</h2>
        </div>
        ...
        <form onSubmit={handleAddAdmin} className="flex gap-4">
          <div className="flex-1 relative">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-brand/20 focus:border-indigo-brand transition-all"
            />
          </div>
          <button 
            type="submit"
            disabled={saving || !newEmail}
            className="bg-indigo-brand text-white px-8 py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-orange-brand transition-colors disabled:opacity-50 flex items-center gap-2"
          >
      ...
      <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm max-w-2xl">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-indigo-brand uppercase tracking-wider">Socios Actuales</h2>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-indigo-50 border border-indigo-100 rounded-2xl">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-indigo-brand text-white rounded-full flex items-center justify-center font-bold">
                  B
                </div>
                <div>
                  <p className="font-bold text-indigo-brand">{mainAdmin}</p>
                  <p className="text-xs text-indigo-brand/60 uppercase tracking-widest font-black mt-1">Socio Principal (Superadmin)</p>
                </div>
              </div>
            </div>
              ...
              <div key={email} className="flex items-center justify-between p-4 bg-gray-50 border border-gray-100 rounded-2xl group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 uppercase tracking-widest font-black mt-1">Socio Administrador</p>
                  </div>
                </div>
                <button 
